...
const CardSlideshow = ({title, desc, image}) => {
    ...
    return(
        <>
        <div style={{backgroundImage: `url(${image})`}} className=" px-5 pt-8 sm:px-10  bg-no-repeat bg-cover bg-center flex justify-start items-center w-[360px] h-[225px] gap-[20px] sm:w-[1440px] sm:h-[587px] sm:gap-[10px] bg-liner-to-b from-[#000000]-0 to-[#101213DB]-800 ">
            <div className=" flex-col w-[320px] h-[118px] gap-[12px] sm:w-[1280px] sm:[233px] sm:gap-[40px] mt-12">
                {/* teks slideshow */}
                <div className="sm:w-[668px] sm:h-[148px] sm:gap-[20px]">
                    ...
                    <p id="p-slide" className="relative sm:bottom-[85vh] max-sm:truncate w-[320px] h-[40px] text-[12px] sm:w-[668px] sm:h-[75px] sm:text-[18px] text-white font-normal ">{desc}</p>
                </div>
             
                {/* navigasi */}
                <div id="slideNavigation" className="sm:mt-[10vh] w-[320px] h-[25px] sm:w-[1280px] sm:h-[45px]  flex justify-between  text-white ">
